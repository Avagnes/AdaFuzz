...
class AdaFuzz:
    ...
    def __init__(self, family_size, delay_factor=0, corpus_factor=0.5, corpus_ratio=20):
        ...
        self.optimizer = torch.optim.Adam(list(self.rnd.predictor_net.parameters()), lr=1e-6)
    ...
    def get_pose(self):
        ...
        seed, reward = self.families[family_index].get_seed()
