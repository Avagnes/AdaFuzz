...
if __name__ == "__main__":
    ...
    parser.add_argument("--algo", default='mdpfuzz', type=str, choices=['mdpfuzz', 'adafuzz', 'gmodel', 'curefuzz'])
    ...
    if args.replay:
        ...
        with open('./results'+result_folder+'/'+args.algo+'_timing'+str(args.seed)+'.txt', 'w', buffering=1) as f:
            sys.stdout = f
            run(
                args,
                Path(args.path_folder_model),
